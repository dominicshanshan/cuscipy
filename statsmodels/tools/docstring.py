"""
Substantially copied from cupyDoc 1.0pre.
"""
import copy
import inspect
import re
...
class cupyDocString(Mapping):
    """Parses a cupydoc string to an abstract representation
...
class Docstring(object):
    ...
    def __init__(self, docstring):
        ...
        if docstring is None:
            return
        self._ds = cupyDocString(docstring)
    ...
    def replace_block(self, block_name, block):
        ...
        block : object
            ...
            match how the block is stored by cupyDocString.
        """
        if self._docstring is None:
            # Protection against -oo execution
            return
